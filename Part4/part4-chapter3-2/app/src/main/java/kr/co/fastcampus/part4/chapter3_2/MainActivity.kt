...
fun Greeting(name: String) {
    ...
    //Text(text = "Hello $name", color = Color.Red, fontSize = 30.sp, fontWeight = FontWeight.Bold)

    // 스텝 5: fontFamily에 FontFamily.Cursive를 전달해봅시다.
    //Text(text = "Hello $name", color = Color.Red, fontSize = 30.sp, fontWeight = FontWeight.Bold, fontFamily = FontFamily.Cursive)
    ...
    /*Text(
        text = "Hello $name Studio IceCream Cake",
        color = Color.Red,
        fontSize = 30.sp,
        fontWeight = FontWeight.Bold,
        fontFamily = FontFamily.Cursive,
