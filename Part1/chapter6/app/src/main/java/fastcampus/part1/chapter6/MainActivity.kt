...
class MainActivity : AppCompatActivity() {
    ...
    private fun start() {
        timer = timer(initialDelay = 0, period = 100) {// 밀리세컨드
            ...
            if (currentDeciSecond == 0 && currentCountdownDeciSecond < 31 && currentCountdownDeciSecond % 10 == 0){
                val toneType = if(currentCountdownDeciSecond == 0) ToneGenerator.TONE_CDMA_HIGH_L else ToneGenerator.TONE_PROP_BEEP
